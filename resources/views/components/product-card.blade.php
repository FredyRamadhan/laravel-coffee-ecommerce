<a href="/products/{{ $slug }}" class=""> 
  <div class="max-w-sm mx-auto h-full bg-white dark:bg-onyx border border-timber dark:border-myrtle rounded-lg shadow-md overflow-hidden hover:shadow-xl transition">
      <div class="h-48 bg-timber dark:bg-myrtle flex items-center justify-center">
        ...
        <img src="/images/{{ $slug.'.jpg' }}" alt="{{ 'Gambar '.$slug }}">
      </div>
